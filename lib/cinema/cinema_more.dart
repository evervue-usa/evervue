...
class CinemaMorePage extends StatefulWidget {
  const CinemaMorePage({super.key, required this.onPageSelected});

  final Function(Widget) onPageSelected;

  @override
  State<CinemaMorePage> createState() => _CinemaMorePageState();
}

class _CinemaMorePageState extends State<CinemaMorePage> {
  final List<Map<String, dynamic>> buttonOpt = [
    {
      'image': 'https://www.evervue.com/evervue/assets/cinema-specs-icon.jpg',
      'link': SpecsViewer(
        pdfTitle: 'Mirror Specifications (PDF)',
        pdfSpecs: 'assets/specification/cinema-specification-table.pdf',
      ),
      'text': 'Cinema Specifications'
    },
  ];
        ...
        child: Column(
          children: [
            CachedNetworkImage(
              ...
              imageUrl:
                  'https://www.evervue.com/evervue/assets/cinema-banner-more.jpg',
              width: screenWidth,
            ),
            Container(
                      ...
                      children: buttonOpt.asMap().entries.map((entry) {
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            if (link is Widget &&
                                option['text'] == 'Cinema Specifications') {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
