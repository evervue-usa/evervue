...
class MirrorGlassSection extends StatefulWidget {
  const MirrorGlassSection({super.key});

  @override
  State<MirrorGlassSection> createState() => _MirrorGlassSectionState();
}

class _MirrorGlassSectionState extends State<MirrorGlassSection> {
  @override
